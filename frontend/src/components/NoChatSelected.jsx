...
const NoChatSelected = () => {
  return (
    <div className="w-full flex flex-1  item-center justify-center py-40  bg-base-100/50">
        <div className="max-w-lg text-center  px-2 space-y-6 ">
            {/* icon */}
            ...
            {/* welcome */}
            <h2 className="text-2xl font-bold ">Welcome to ReChat!</h2>
